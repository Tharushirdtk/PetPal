...
const UsersTab = () => {
  ...
  return (
    <div className="space-y-4">
      {/* Header */}
      <div>
        <h2 className="text-lg font-bold text-gray-900">{t('admin_users_title') || 'Registered Users'}</h2>
          ...
          <table className="w-full">
            ...
            <tbody>
              {loading ? (
                ...
                users.map((u) => (
                  <tr key={u.id} className="border-b border-[#E5E7EB] last:border-b-0 hover:bg-gray-50 transition-colors">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={page <= 1}
              className="p-2 rounded-lg border border-[#E5E7EB] bg-white text-gray-400 hover:bg-gray-50 transition-colors cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
            >
