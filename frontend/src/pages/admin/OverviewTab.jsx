...
const OverviewTab = ({ onTabChange }) => {
    ...
    return (
      <div className="space-y-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="bg-white rounded-2xl border border-[#E5E7EB] p-5 shadow-sm animate-pulse">
              <div className="flex items-start justify-between">
  ...
  return (
    <div className="space-y-6">
      {/* Welcome header */}
      <div>
        <h1 className="text-xl font-bold text-gray-900">{t('admin_welcome')}</h1>
        <p className="text-sm text-gray-500 mt-1">{t('admin_welcome_sub')}</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-[#E5E7EB] shadow-sm">
        <div className="flex items-center justify-between p-5 border-b border-[#E5E7EB]">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold text-gray-900 text-sm">{t('admin_recent_contacts')}</h3>
          </div>
              ...
              <div key={c.id} className="p-4 hover:bg-gray-50 transition-colors">
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-gray-900 truncate">{c.heading}</p>
